...
@section('admin_content')
  @php
    use Carbon\Carbon;
    $Products = !empty($data['all_products']) ? $data['all_products'] : null;
  @endphp
                  ...
                  <tr>
                      ...
                      <td>
                          <span class="text-ellipsis">
                              @if ($item->products_status == 'activated')
                                  <!-- Trạng thái chưa kích hoạt -->
                                  <a href="{{ route('ROUTE_UNACTIVE_PRODUCTS', ['id' => $item->products_id]) }}">
                                      <span class="fa-thumb-styling fa fa-thumbs-up"></span>
                                  </a>
                              @else
                                  <!-- Trạng thái đã kích hoạt -->
                                  <a href="{{ route('ROUTE_ACTIVE_PRODUCTS', ['id' => $item->products_id]) }}">
                      ...
                      <!-- Các hành động -->
                      <td>
                          <a href="{{ route('ROUTE_EDIT_PRODUCTS', ['id' => $item->products_id]) }}" class="active styling edit" ui-toggle-class="">
                              <i class="fa fa-check fa-pencil-square-o text-success text-active"></i>
                          </a>
                          <a onclick="return confirm('Are you sure to delete?');" href="{{ route('ROUTE_DELETE_PRODUCTS', ['id' => $item->products_id]) }}" class="active styling edit">
